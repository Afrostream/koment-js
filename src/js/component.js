...
class Component {
  ...
  static getComponent (name) {
    ...
    if (window && window.koment && window.koment[name]) {
      log.warn(`The ${name} component was added to the koment object when it should be registered using koment.registerComponent(name, component)`);
  ...
  static extend (props) {
    ...
    log.warn('Component.extend({}) has been deprecated, use koment.extend(Component, {}) instead');
