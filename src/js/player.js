...
class Player extends Component {
  ...
  createEl () {
    ...
    if (window.koment_NO_DYNAMIC_STYLE !== true) {
      ...
      const defaultsStyleEl = Dom.$('.koment-styles-defaults');
      const head = Dom.$('head');
  ...
  loadTech_ (techName) {
    ...
    let TechComponent = Tech.getTech(this.techName_);
  ...
  handleTechWaiting_ () {
    ...
    this.one('timeupdate', () => this.removeClass('koment-waiting'));
  }
  ...
  enterFullWindow () {
    ...
    Dom.addElClass(document.body, 'koment-full-window');
  ...
  exitFullWindow () {
    ...
    Dom.removeElClass(document.body, 'koment-full-window');
