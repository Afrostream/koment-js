...
class MouseTimeDisplay extends Component {
  ...
  constructor (player, options) {
    ...
    if (options.playerOptions &&
      options.playerOptions.progressControl &&
      options.playerOptions.progressControl.keepTooltipsInside) {
    ...
    player.on('ready', () => {
      this.on(player.progressControl.el(), 'mousemove', throttle(Fn.bind(this, this.handleMouseMove), 25));
    });
  }
